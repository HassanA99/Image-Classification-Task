...
# DATE CREATED: Monday, July 15, 2024                              
# REVISED DATE: Monday, July 26, 2024
...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    # Read the dog names from the dogfile into a dictionary
    dognames_dic = dict()
    ...
    # Iterate through the results dictionary to adjust for whether labels are of-a-dog or not
    for key in results_dic:
        ...
        # Extend the results dictionary with the new information
