...
# DATE CREATED: Monday, July 16, 2024                              
...
def calculates_results_stats(results_dic):
    ...
    # Iterate through the results dictionary to count statistics
    for key in results_dic:
        # Pet Image Label is a dog
        if results_dic[key][3] == 1:
            n_dogs_img += 1
            # Classifier Label is a dog and they match
    ...
    # Populate the results statistics dictionary
